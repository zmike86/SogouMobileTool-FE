...
;(function (name, factory, context) {
    ...
    function isKeyword(id) {
        ...
        switch (id.length) {
            ...
            case 3:
                ...
                break;
            case 4:
                keyword = (id === 'this') || (id === 'else') || (id === 'case') || (id === 'void') ||
                    (id === 'with') ||(id === 'enum');
                break;
            case 5:
                keyword = (id === 'while') || (id === 'break') || (id === 'catch') || (id === 'throw') ||
                    (id === 'const') || (id === 'yield') || (id === 'class') || (id === 'export') ||
                    (id === 'import') || (id === 'super');
                break;
            case 6:
                ...
                break;
            case 7:
                keyword = (id === 'default') || (id === 'finally') || (id === 'package') || (id === 'private') ||
                    (id === 'extends');
                break;
            case 8:
    ...
    function analyze(text){
        ...
        {
            value = array[len];
            if (!valuemap[value]&&!isKeyword(value)&&!this[value])
            {
